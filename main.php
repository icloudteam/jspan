...
$.template( "fileTemplate", markup );
  ...
  $(function(){
    ...
    '<div id="qrcode"></div>',
        '<h4>分享文件地址 http://hdfsm.qmcr.me:50075/webhdfs/v1/',filepath,'?op=OPEN</h2>',
      '</center></div>',
  ...
  $(tmpl).modal();
    ...
    '<div class="modal hide fade" tabindex="-1" data-width="760">',
      ...
      '</div>',
      '<div class="modal-body">',
        '<h4><a href="http://weibo.com/u/206161800">申健</a></h4>',
        '<h4><a href="http://weibo.com/2188332174">孙晓宁</a></h4>',
        '<h4><a href="http://weibo.com/u/1867431461">关永翔</a></h4>',
        '<h4><a href="http://weibo.com/maxwell1389">黎小兵</a></h4>',
        '<h4><a href="http://weibo.com/207123093">侯晓辰</a></h4>',
        '<h4><a href="http://weibo.com/u/1664171265">吴芳</a></h4>',
        '<h4><a href="http://user.qzone.qq.com/138265383?ptlang=2052">周腾宇</a></h4>',
      '</div>',
      '<div class="modal-footer">',
        '<a href="#" data-dismiss="modal" class="btn  btn-primary">确定</a>',
      '</div>',
